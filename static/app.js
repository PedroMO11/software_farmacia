...
function agregarAlCarritoClicked(event){
    ...
    var codigo = item.getElementsByClassName('codigo-item')[0].innerText;
...
function agregarItemAlCarrito(titulo, precio, imagenSrc,codigo){
    ...
    fetch('/add_to_shopping_cart/' + codigo, {method: 'POST'}).then( () => {
        console.log('Item agregado a carrito');
    }
    )
}
...
function eliminarItemCarrito(event){
    ...
    fetch('/remove_item_from_shopping_cart/' + codigo, {method: 'POST'}).then( () => {
...
function actualizarTotalCarrito(){
    ...
    document.getElementsByClassName('carrito-precio-total')[0].innerText = 'S/.'+total.toLocaleString("pe");
